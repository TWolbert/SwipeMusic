...
function EditDialog({ playlist }) {
  ...
  return /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsx("button", { className: " text-accent-500 hover:text-accent-700 rounded-xl text-background p-2 flex items-center gap-2", children: /* @__PURE__ */ jsx(Gear, {}) }) }),
      ...
      /* @__PURE__ */ jsx(DialogContent, { className: "fixed inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("form", { onSubmit: submit, method: "PUT", className: "flex flex-col gap-4", children: [
